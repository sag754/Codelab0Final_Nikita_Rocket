...
{
    public static GameManagerScript instance = null;               //establishes a reference to a BGMScript and sets the reference to null when this objected is created
    ...
    {
        currentLevel++;                                            //increments 'currentLevel' int variable by +1 so that it loads the next scene/level
